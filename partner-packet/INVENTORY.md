# Prime Field Technologies — Master Inventory

Organized asset list for partner outreach.  
Compiled from public sources: LinkedIn, Base44, GitHub, Zenodo authorship, company sites.  
**Last sweep:** 2026-07-14

Contact: js@primefieldtechnologies.com  
Savannah, GA · Founder/CEO: Jonathan Simons, CRNA  
X: [@jrsimons357](https://x.com/jrsimons357) · LinkedIn: [prime-field-technologies](https://www.linkedin.com/in/prime-field-technologies)
...
- **Games (in production)** — strategy title with a wink to RISK; Pac-Man retro-3D; AI Surgeon VR · hub: https://primefield.tech/games · **animation trailer script:** [`AI-SURGEON-VR-animation-script.md`](AI-SURGEON-VR-animation-script.md)
...
## 3. Zenodo research papers (Jonathan Simons / Jonathan R. Simons / Jonathan Robert Simons)

Author search on Zenodo returns a large set under Prime Field affiliation.  
**Collection search:** https://zenodo.org/search?q=creators.name%3A%22Simons%2C%20Jonathan%22

### Millennium / spectral core
1. The Quantum Lens: A Spectral Framework Connecting the Millennium Prize Problems
2. The GCD Spectral Attractor: A Unified Structural Framework for Navier-Stokes, the Riemann Hypothesis, and the Simons Field Equation
3. The Q_N Operator: Self-Adjointness, Spectral Floor, and a Route to the Riemann Hypothesis via Renormalized GCD Eigenvalues
4. Route C: Spectral Closure of the Zero-Density Law — Conditional on Two Analytic Gaps
5. Spectral Properties of GCD Operators and Ramanujan Quadratic Forms
6. The Ramanujan–Möbius Identity and Prime Lattice Spectral Theory
7. The Montgomery–Dyson Coincidence Resolved by the Q6 Prime Lattice Operator
8. The Montgomery–Dyson Coincidence as a Q6 Prime Lattice Eigenvalue Identity
9. A Quantum Field Theory on the Prime Manifold: Navier–Stokes, Riemann Hypothesis, and Goldbach Under a Single Hamiltonian
10. A Q6 Spectral Route to the Strong Goldbach Conjecture
11. The Prime Lattice as a Prototype for the BSD Hamiltonian (Birch–Swinnerton-Dyer)
12. A Universal Non-Concentration Principle: SND ≡ GNC ≡ Bridge

### Navier–Stokes / fluids / maritime-adjacent energy cascade
13. Spectral Non-Concentration Implies Global Regularity for 3D Navier–Stokes on T³
14. Spectral Non-Concentration Criteria for Navier–Stokes Regularity on T³
15. Spectral Non-Dispersal, the Ring Lemma, and a Conditional Regularity Framework for Navier–Stokes on T³
16. Borromean Triads, the Ring Lemma, and Spectral Non-Dispersal (conditional regularity)
17. Global Regularity of the Navier-Stokes Equations on T3: Spectral Non-Dispersal, Ring Lemma, Phi-Renormalization…
18. Phi-Renormalization for Axisymmetric-with-Swirl Navier–Stokes (several variants)
19. Diffuse Cascade in 3D Navier–Stokes: Time-Resolved Evidence for Triad Equidistribution
20. Explicit Decay Rate and Quantitative Threshold for the SND Gronwall Inequality

> How this maps for partners: the NS / spectral-energy papers are the technical spine for **maritime flow, turbulence control, and energy systems**. LinkedIn also has the public note on dispersive correction / regularization for NS simulations (“technical paper available on request”).

---

## 4. Domain brief — what to show for each ask
...
## 5. Inventions & IP (hand these carefully)
...
- Prior government submissions that were declined — available as archival dossier under NDA (“rejected ≠ invalid”)

---

## 6. Companies in the group

| Entity | Role |
| --- | --- |
| Prime Field Technologies, LLC | Core math → encryption, prediction, field systems |
| Simons Medical Innovations, LLC | Solenne, medical/AI/VR training |
| Winchester Anesthesia, LLC (prior) | CRNA practice foundation |
| Zeppelin Designs, LLC (prior) | Invention / device work |

---

## 7. What to send *today* (recommended stack)

1. **`brochure.html`** — open in browser → Print → Save as PDF (looks like a brochure, not a draft dump)
2. **This inventory** — so they see organization and full scope
3. **3 live links max in the message body:** primefield.tech · ExoRatio · Primefield Explorer  
4. Offer: “Full Zenodo set + defense dossier + patent claims available under NDA / shared drive.”

Optional: don’t attach 20 PDFs on day one. Attach the brochure PDF + offer the vault.
