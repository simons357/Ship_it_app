...
**Tsai.** Local-energy self-similar profiles are out
...
not an a priori on \(X\), and it is not a singularity.
Hao, Vladimír — if the pitchfork is proved, that is
Leray–Hopf non-uniqueness for non-smooth data. It does
not write the blank.
...
**Schonbek.** Fourier splitting gives algebraic \(L^2\)
decay of weak solutions (Arch. Rational Mech. Anal. 88,
...
**Hishida.** Evolutionary NS in an exterior domain is a
setting. Spatial decay and a Stokes semigroup are not a
...
**Vasseur.** De Giorgi iteration proves the same CKN
partial regularity (NoDEA 2007). Hausdorff one-measure
...
not a bound on \(X\). Reinhard, Vlad — do not cash
Onsager for NS as regularity.
