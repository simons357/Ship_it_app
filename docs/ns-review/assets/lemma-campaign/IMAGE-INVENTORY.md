...
- `/opt/cursor/artifacts/lemma-star-paper/`

## Jonathan-shared barycenter maps (USE THESE)

| File | Source | Use |
| --- | --- | --- |
| `lemma-star-barycenter.png` | Attached orbit map (`c37e89b5-…png`) | Hero: mapped to center; door locked; Attacks 9A–9D |
...
| File | Source | Use |
| --- | --- | --- |
| `amp_ratios_triad.png` | five-lane recovery results | Attack 2: K=0 blows |
| `attack5_bounds.png` | five-lane recovery results | Attack 5 kill drill |
| `fig_star_david_ring_lemma.png` | Zenodo spectral pack `19842060` | Finite triad ring |
| `fig_three_spheres.png` | Zenodo spectral pack `19842060` | Shell → transfer → vorticity |
| `t3_torus_shape_render.png` | Zenodo spectral pack `20272545` | Conceptual T³ atmosphere |

## Honesty footer (every new diagram)
