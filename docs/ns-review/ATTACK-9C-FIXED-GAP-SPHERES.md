...
**Canonical five-lane twin:** [`five-lane-recovery/docs/math/ns_attacks/ATTACK_9C_FIXED_GAP_SPHERES.md`](./five-lane-recovery/docs/math/ns_attacks/ATTACK_9C_FIXED_GAP_SPHERES.md)  
...
|-----------------|--------|
| Dedicated 9C probe under `scripts/ns_attacks/` | **Absent** |
...
Do **not** invent a sweep artifact. Quotient name: **`ratio_R_star_shape`** only (not legacy `ratio_star`).
