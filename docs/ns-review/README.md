...
- [`TJ-SAME-SCALE-CANDIDATES.md`](./TJ-SAME-SCALE-CANDIDATES.md) — narrow-first attack shortlist for \(T_{j\leftarrow j}\) / (A); DEAD vs TRY; hard-run of survivors (§5)
...
Reproducibility: [`scripts/ns_attacks/`](../../scripts/ns_attacks/). Same-scale probes: `python3 scripts/ns_attacks/tj_same_scale_candidate_probes.py` · hard run: `python3 scripts/ns_attacks/tj_survivors_hard_run.py`.
