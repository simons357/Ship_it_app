...
> **Companion archive (older proof attempt, annotated 10 Sep 2026):** [`PROOF_LemmaStar_STATUS.md`](./PROOF_LemmaStar_STATUS.md).  
> That archive is **history** — it does **not** green ★. This file remains the **LIVE** kill/proof-lane lock (Attack 8/9A–9D).
...
**Correct record:** [`ATTACK_8_CORRECT_RECORD.md`](../math/ns_attacks/ATTACK_8_CORRECT_RECORD.md)  
**Exact triad formulas:** [`LEMMA_STAR_EXACT_FORMULAS.md`](../math/ns_attacks/LEMMA_STAR_EXACT_FORMULAS.md)
...
[`LEMMA_STAR_SHAPE_FORM.md`](../math/ns_attacks/LEMMA_STAR_SHAPE_FORM.md). Long expansions: [`LEMMA_STAR_EXACT_FORMULAS.md`](../math/ns_attacks/LEMMA_STAR_EXACT_FORMULAS.md).
...
\]
(Alias: older docs \(\mathcal{D}_s=Z-\Lambda Y\) — same as \(D_s\). Equivalent triad form \(T_c=M-\Lambda N=\sum_k\lambda_k(\lambda_k-\Lambda)T_k\): [`LEMMA_STAR_EXACT_FORMULAS.md`](../math/ns_attacks/LEMMA_STAR_EXACT_FORMULAS.md).)
...
**Near-shell \(K_{\alpha,\beta}\):** restricted limiting-family probe only — **not** the full lemma ([`ATTACK_9B_EXACT_SHELL_CLOSING.md`](../math/ns_attacks/ATTACK_9B_EXACT_SHELL_CLOSING.md)).
...
Route N / Q6 / LP-shell floors: [`ARCHIVE_ROUTE_N_Q6_SHELL/`](../math/ns_attacks/ARCHIVE_ROUTE_N_Q6_SHELL/), [`../ARCHIVE_NOT_LEMMA_STAR.md`](../ARCHIVE_NOT_LEMMA_STAR.md). Ledgers stay linked, labeled **NOT Lemma★**.

## Related files

- [`PROOF_LemmaStar_STATUS.md`](./PROOF_LemmaStar_STATUS.md) — annotated **archive** proof attempt (does **not** green ★)
