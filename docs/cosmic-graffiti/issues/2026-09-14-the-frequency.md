...
![Cosmic Graffiti masthead: an ornate galaxy-letter G on a dark sky, gold frequency lines, dated 14 September 2026](assets/cg-frequency-masthead-2026-09-14.png)
...
![The Frequency mark: a gold nested waveform in a dark filigree squircle](assets/cg-frequency-mark.png)
...
![Overhead photograph of a white coffee cup on a wooden table, cream swirling in the coffee, a spoon beside it](assets/cg-around-us-coffee-swirl.png)
...
![Five letter-headed guests at a dim party. Four identical Phi characters wear name tags dump output, swirl uθ/r, gravity Φg, and golden φ; an H wears two tags, Paper2 HN and coupling H. Coffee has been spilled. Caption: SAME LETTER ≠ SAME OBJECT.](assets/cg-humor-letters-collide.png)
