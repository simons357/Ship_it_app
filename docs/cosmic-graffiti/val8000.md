...
Skins are accessories on that same square — hats, glasses, issue pins —
not a second character. Default skin: the naked square. How to change:
[`val8000-skins.md`](val8000-skins.md).
...
The mouth is a **straight line while idle**. After a normal answer, he
**usually smiles** (the line curls). That is the default post-answer face.

**Metal teeth** fire when:

1. Someone compliments him.
2. He tells a funny joke.
3. He uses sarcasm.

Teeth when someone compliments him.

Teeth when he tells a funny joke.

Teeth when he uses sarcasm.

Teeth are not after ordinary straight explanations. Teeth are never idle.
Teeth stay off the masthead.

### Mouth / art

Idle line and the after-answer smile can sit as a thin line BELOW the lens
(those are not teeth).

Metal teeth occupy the INNER CONCENTRIC CAMERA RINGS. The aperture lines become the grille.
The lens IS the mouth.
No chin, no separate jaw, no teeth hanging off the bottom of the square.
No cartoon jaw under the square.
No smile-line-plus-teeth-below.

That is the gag: when he flashes metal, you are looking INTO the camera and seeing teeth in the rings.

The PNGs are original PIL/numpy marks on the existing red circular lens
and dark square. Gold-free. VAL8000 on the panel. No HAL 9000 wordmark.
No film stills.

Three-state sheet: [`assets/val8000-mouth-sheet.png`](assets/val8000-mouth-sheet.png).
...
| State | File | When |
|---|---|---|
| **Line (idle)** | [`assets/val8000-mouth-line.png`](assets/val8000-mouth-line.png) | Idle. Always. Masthead. Waiting. Thin line below the lens. Not teeth. |
| **Smile (after a normal answer)** | [`assets/val8000-mouth-smile.png`](assets/val8000-mouth-smile.png) | After a normal answer, he usually smiles. Default post-answer face. Thin curl below the lens. Not teeth. |
| **Metal teeth** | [`assets/val8000-mouth-teeth.png`](assets/val8000-mouth-teeth.png) | Compliment, funny joke, or sarcasm. Inner concentric camera rings. Aperture grille. Never a cartoon jaw. Never idle. Never masthead. Not after ordinary straight explanations. |

Idle mouth: a straight line.

Idle is not a smile. Idle is not teeth.
...
*Idle. Straight line below the lens. Not teeth.*

![VAL8000 mouth smile](assets/val8000-mouth-smile.png)

*After a normal answer. The line curls below the lens. Not teeth.*

![VAL8000 metal teeth](assets/val8000-mouth-teeth.png)

*Metal teeth occupy the inner concentric camera rings. The aperture lines are the grille. You are looking into the camera. Not a cartoon jaw under the square. Compliment, joke, or sarcasm. Not idle. Not masthead.*

![VAL8000 three mouth states — line, smile, teeth in the rings](assets/val8000-mouth-sheet.png)

*Three states. Teeth panel: teeth in the rings. Not a jaw under the square.*
...
| Credit: `VAL8000 · AI commentator` | Idle line on the masthead; smile after a normal answer; teeth on compliment, joke, or sarcasm |
...
- Idle the mouth as a straight line. After a normal answer, he usually
  smiles. Metal teeth when someone compliments him, when he tells a
  funny joke, or when he uses sarcasm. Idle and smile sit below the
  lens. Metal teeth occupy the inner concentric camera rings.
- Default skin is the naked square. Accessories clip on; they do not
  replace the face.
...
- Put a smile on the masthead while idle. Put metal teeth on the masthead.
  Use teeth after an ordinary straight explanation. Hang a cartoon jaw
  off the bottom of the square. Put teeth under the lens as a separate mouth.
...
The Frequency (sourced news, URL, date)
    → VAL8000 (idle line; smile after a normal answer; teeth on compliment, joke, or sarcasm)
...
Line while I wait. Smile after a normal answer.
Teeth when you compliment me. Teeth when the joke lands.
Teeth when I go sarcastic.
...
a straight mouth line while idle, a smile after a normal answer, original
mark, raps the comment after the report. He is not a person. He is not
running the lab. If the claim is open, he leaves the door open.
...
below the lens). After a normal answer: `val8000-mouth-smile.png` (the
line curls below the lens — not teeth). Teeth when someone compliments
him, when the joke lands, or when he is sarcastic — never the masthead.
Teeth live in the inner concentric camera rings (`val8000-mouth-teeth.png`);
the lens is the mouth, not a cartoon jaw. Three states:
`val8000-mouth-sheet.png`. Wide crop: `val8000-eye-header.png`. Alt idle:
“VAL8000, original red circular lens and a straight mouth line on a dark
panel.”
