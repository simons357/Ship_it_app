...
| **Smile (after a normal answer)** | [`assets/val8000-mouth-smile.png`](assets/val8000-mouth-smile.png) | After a normal answer, he usually smiles. Default post-answer face. |
| **Metal teeth** | [`assets/val8000-mouth-teeth.png`](assets/val8000-mouth-teeth.png) | Compliment, funny joke, or sarcasm. Never idle. Never masthead. Not after ordinary straight explanations. |
...
*After a normal answer. The line curls.*

![VAL8000 metal teeth](assets/val8000-mouth-teeth.png)

*Metal teeth. Compliment, joke, or sarcasm. Not idle. Not masthead.*
...
- Idle the mouth as a straight line. After a normal answer, he usually
  ...
  funny joke, or when he uses sarcasm.
...
- Put a smile on the masthead while idle. Put metal teeth on the masthead.
  Use teeth after an ordinary straight explanation.
...
After a normal answer: `val8000-mouth-smile.png` (the line curls). Teeth
when someone compliments him, when the joke lands, or when he is sarcastic
— never the masthead. Wide crop: `val8000-eye-header.png`. Alt idle:
...
Mouth timing on this page is unchanged. Gestures are not skins.
See [`val8000-gestures.md`](val8000-gestures.md).
