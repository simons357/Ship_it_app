...
| CosmoEvolution Aug 2026 *Prime Number Distribution in Black Hole QNM Spectra* | [`docs/archive/hb-ringdown/QNM_Prime_Zeta_DA_Analysis_2026-08.md`](../archive/hb-ringdown/QNM_Prime_Zeta_DA_Analysis_2026-08.md). **Archive only.** Unification **withdrawn** (26 Aug DA audit). Keep Motl–Neitzke / Berti / Euler product as citations. Experiment 01 stays **closed** (H0 not rejected). Not RH. Not live DA. Not Q6 \(H_N\). |
