...
| Harmonic Blueprint book files (hardback DOCX, 150-page PDF, research map, white paper txt, Ch.8 txt) | **not received** on this VM. Receipt: [`docs/archive/sfe-hb/HARMONIC-BLUEPRINT-BOOK-FILES.MISSING.md`](../archive/sfe-hb/HARMONIC-BLUEPRINT-BOOK-FILES.MISSING.md). A truncated Chapters I–III paste is [`SFE_Breathing_Field_Book_Paste.md`](../archive/sfe-hb/SFE_Breathing_Field_Book_Paste.md). **Not** GR+QM unification. **Not** RH. **Not** live DA. |
