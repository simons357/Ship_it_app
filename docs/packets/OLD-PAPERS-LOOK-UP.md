...
| 14 Aug 2026 *Harmonic perspective on RH* | [`docs/archive/sfe-hb/Harmonic_Perspective_on_RH_2026-08-14.md`](../archive/sfe-hb/Harmonic_Perspective_on_RH_2026-08-14.md). **Archive only.** Hard rule: SFE / UHF / DHFA / QStack do **not** prove RH. Bridge lemma **OPEN**. Not live DA. Not Clay. Companion to the 19 Aug UHSA dump, not a substitute for Track B Q6. Map: [`docs/archive/sfe-hb/README.md`](../archive/sfe-hb/README.md). |
| *Unified Harmonic Solutions to the Millennium Problems* (SFE primer) | [`docs/archive/sfe-hb/Unified_Harmonic_Solutions_Millennium_Problems.md`](../archive/sfe-hb/Unified_Harmonic_Solutions_Millennium_Problems.md). **Archive only.** Heading “Solved or Interpreted” **rejected as a solve**. Not Clay. Not live DA. Table is interpretation, not a theorem. |
| Harmonic Blueprint book files (150-page PDF, research map, white paper txt, Ch.8 txt) | Drive hardback **arrived:** [`Harmonic_Blueprint_HARDBACK.docx`](../archive/sfe-hb/Harmonic_Blueprint_HARDBACK.docx) SHA `57e0a0bcf25f…`. `The_Harmonic_Blueprint_FULL.docx` **arrived as a stub** (SHA `fe4bbc6875…`) — **not** the book. Named 150-page PDF **arrived as a 12-page padded stub** ([`The_Harmonic_Blueprint_FULL_150_PAGES.pdf`](../archive/sfe-hb/The_Harmonic_Blueprint_FULL_150_PAGES.pdf) SHA `c6d669f140…`) — **not** 150 pages. Chapter 8 “SFE Explained” txt **not received** ([`Chapter8-SFE-Explained.MISSING.md`](../archive/sfe-hb/Chapter8-SFE-Explained.MISSING.md)). White paper txt **arrived** ([`Simons_Field_Equation_White_Paper.txt`](../archive/sfe-hb/Simons_Field_Equation_White_Paper.txt) SHA `72b5507c…`) — outline, **not** a theorem. Book-opening Glass paste is the **same truncated file** already archived ([`SFE_Breathing_Field_Book_Paste.md`](../archive/sfe-hb/SFE_Breathing_Field_Book_Paste.md)); Chapter III body now as it arrived. **Not** a unification theorem. Research map still **not received**. Receipt: [`docs/archive/sfe-hb/HARMONIC-BLUEPRINT-BOOK-FILES.MISSING.md`](../archive/sfe-hb/HARMONIC-BLUEPRINT-BOOK-FILES.MISSING.md). Map: [`Harmonic_Blueprint_HARDBACK.RECEIPT.md`](../archive/sfe-hb/Harmonic_Blueprint_HARDBACK.RECEIPT.md). **Not** GR+QM unification. **Not** RH. **Not** live DA. |
...
| CosmoEvolution Aug 2026 *Prime Number Distribution in Black Hole QNM Spectra* | Historical source [`docs/archive/hb-ringdown/QNM_Prime_Zeta_DA_Analysis_2026-08.md`](../archive/hb-ringdown/QNM_Prime_Zeta_DA_Analysis_2026-08.md) (unification **withdrawn**). Split note that can stand as a paper: [`QNM_ZETA_WHAT_REMAINS.md`](../archive/hb-ringdown/QNM_ZETA_WHAT_REMAINS.md). Keep Motl–Neitzke / Berti / Euler product as citations. Experiment 01 stays **closed**. Not RH. Not live DA. Not Q6 \(H_N\). |
| Gap 1 Reconciliation handoff (`907cc125a_GAP1_RECONCILIATION_HANDOFF.md`) | **arrived.** Base44 HTTP **302** then **200**, 8 147 bytes. SHA-256 `5c2f4994ea44f589b50502a448ee85f7f4ce1c1ec9290d5761ca1bb7ce8f6960`. Title *Gap 1 Reconciliation — Handoff to Grok / Claude*; June 8, 2026. File: [`docs/papers/gcd/GAP1_RECONCILIATION_HANDOFF.md`](../papers/gcd/GAP1_RECONCILIATION_HANDOFF.md). Hash-prefix **not re-filed**. Two operators \(1/(\mathrm{gcd}\sqrt{ij})\) vs \(\mu(i/g)\mu(j/g)g/\sqrt{ij}\) are **NOT identical**. Numerical \(\lambda_{\min}/\log N\) toward \(-1/(2\pi)\) is **NOT a theorem**. Step F / Fujii seam **OPEN**. Do **not** invent the 10–20 line closure. Do **not** claim \(C\approx 0.04706\) completes a proof. Source “NS unconditional” / “RH follows” **rejected**. Q6 PD stands as inverse-GCD arithmetic; all-\(N\) floor **withdrawn**. **Not** August Q6 PDF `a2391122…`. **Not** MAGNUM `f41194c7…`. **Not** Clay. **Not** live DA. **Not** Nav42 paint. Receipt: [`docs/papers/gcd/GAP1_RECONCILIATION_HANDOFF.RECEIPT.md`](../papers/gcd/GAP1_RECONCILIATION_HANDOFF.RECEIPT.md). |
| Grok E8 / Nav42 superstructure chat paste | Track C receipt [`docs/archive/nav-42-cbfd-2026-04/GROK-E8-NAV42-SUPERSTRUCTURE.RECEIPT.md`](../archive/nav-42-cbfd-2026-04/GROK-E8-NAV42-SUPERSTRUCTURE.RECEIPT.md). E8 / Leech / Chat Vault / 2.2 Hz paint / QStack-as-product **REJECTED** as live DA. Statistical-success hype **REJECTED**. Goldbach-closed **REJECTED**. Sandbox turbulence-% **not measured** here. Personal overlay was withdrawn from public stacking; not filed. This dump’s \(\Phi\) / Q6 / E8 “spectral floor” is **not** Q6 \(H_N\), **not** Paper2, **not** Ring \(J/X\), **not** swirl \(\Phi\). Do **not** dump the sixteen Grok reports. **Forbidden** in `domain_architect/*.py`. |
| April 2026 Grok NAV-42 / CBFD / \(A_3\) thread (v0–v17) | Archive [`docs/archive/nav-42-cbfd-2026-04/`](../archive/nav-42-cbfd-2026-04/). Track A: \(A_{\omega S}\), \(A_3\), \(D_\xi\), \(H_{NS}\), eigenbasis of \(\omega\cdot S\omega\). False \(A_3\)-multiplier inequality **rejected**. Tracks B/C segregated. Title-only *Strong Draft: Alignment Functionals…* **not received**. Numpy `qc_coherence` / `qr_resonance` and Q OS / Fluid-Q are **Track C**, **forbidden** in `domain_architect/*.py`. Grok Fluid-Q outline arrived; 11524-byte *Master Notes* **not received**. Cylinder-wake demo is **not** live DA. SFE black-hole matplotlib paste **arrived** (Track C); **do not** add an Equation Explorer tab. Grok E8 / Chat Vault / 2.2 Hz paint dump **rejected** as live DA; Goldbach-closed **REJECTED**; GAP1 arrived (SHA `5c2f4994ea44…`, Step F **OPEN**). \(A_3\) \(\neq\) Paper2 SND \(\neq\) Ring \(J/X\). Clay **NOT CLAIMED**. Do **not** dump the sixteen Grok reports. |
