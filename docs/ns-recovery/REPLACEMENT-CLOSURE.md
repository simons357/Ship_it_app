...
|---|---|
| Exact-shell 9D coefficient \(K\le 16/9\) | **CLAIMED.** Written derivation; internal checks; independent specialist pending. Sweeps consistency only. [`ATTACK-9D-FULL-SUPPORT-SCORE.md`](ATTACK-9D-FULL-SUPPORT-SCORE.md). **Not** a regularity close. |
