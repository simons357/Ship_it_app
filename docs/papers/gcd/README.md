...
The 19 Aug 2026 UHSA session dump ([`docs/archive/sfe-hb/`](../../archive/sfe-hb/)) repeats \(Q_N\) positive-definiteness in its §7 “bedrock.” That arithmetic fact belongs **here**. Do not glue it to NS regularity, RH, YM, BSD, or Hodge. The dump is archive-only, not a Q6 product face. The 14 Aug RH harmonic-perspective note in that folder says the same: Blueprint language is not a Mertens transfer lemma. The matplotlib Equation Explorer paste in that folder is **not** Q6 \(H_N\).
