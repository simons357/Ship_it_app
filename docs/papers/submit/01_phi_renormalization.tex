...
\textbf{Disclaimer.} This note treats the axisymmetric-with-swirl class
and a $Q_1$-augmented / Phi-renormalized system. Classical regularity
without augmentation remains open; unconditional 3D Navier--Stokes
is not claimed.}}
\end{center}
\vspace{0.5em}
