...
| **`04_q6_inverse_gcd.tex`** | **Proper Q6 paper** (operators + Bridge\* pair + multi-rep + withdraw floors) | **Replace** `20405589` with this (or new deposit + correction note on old) |
| `04_bridge_star_prime_pairs.tex` | Short Bridge\* extract (pair + multi-rep) | Optional; covered by `04_q6_…` |
...
| `07_positive_gcd_paper1_abc.tex` | Positive-GCD Theorems A/B + C kill | Companion to Zenodo Paper1 `20269738` |
...
- **File:** `04_q6_inverse_gcd.tex`
- **True:** definitions of \(Q_N\), \(\widetilde Q_N\), \(H_N\); Bridge\* \(R(e_p-e_q)>-1/2\); multi-rep \(R(v_k)>-1/2\); nonnegative cone; full-spectrum floor **false**
- **Not true / withdrawn:** Goldbach dark-state route, RH via Bridge floor, NS from Q6, \(\lambda_{\min}>-1/2\) for all \(N\)
- **Closure plan:** `docs/math/CLOSURE-ATTACK-PLAN.md`
