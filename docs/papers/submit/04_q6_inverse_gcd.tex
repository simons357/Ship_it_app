...
\title{\textbf{The Inverse-GCD Operator $Q_N$:\\
Definitions, a Restricted Rayleigh Bound,\\
and Withdrawal of Full-Spectrum Floor Claims}\\[6pt]
\large\textit{Q6 in proper form --- spectral note, not a prize paper}}
...
\textbf{Disclaimer.}
This note defines the inverse-GCD (``Q6'') matrices and proves one
restricted inequality (Bridge$^*$).
It does \emph{not} claim Goldbach, the Riemann Hypothesis, or
Navier--Stokes regularity.
Full-spectrum floors $\lmin>-1/2$ are \emph{false} for the named matrices.}}
\end{center}
\vspace{0.6em}
...
Earlier public drafts used ``Q6'' as a route to Strong Goldbach via a
dark-state lemma and a full-spectrum Bridge floor, and bundled the same
operator into Navier--Stokes / RH packaging. Those claims are withdrawn.
...
The archive DOIs of those drafts may remain as dated history; they are
not the claim of this note.
The corrected public credit for this operator is
...
This note supersedes the Goldbach-packaged Q6 preprint
(\href{https://doi.org/10.5281/zenodo.20405589}{10.5281/zenodo.20405589})
as the author's intended public claim for the inverse-GCD operator.
