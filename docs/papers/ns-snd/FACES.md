...
- **May 18 “implies” draft TeX:** historical submission draft. Same title family as the withdrawn Zenodo “implies” face. **Not** FIXED. **Not** the August controlling face. §7 T2-closed is diseased; leftover **7–8 OPEN**. Clay **NOT CLAIMED**. **Do not use as closed.**
- **April Spectral Coherence DRAFT:** filename alias only. Desktop / Base44 `5dfeb6b64_Paper2_April_Spectral_Coherence_DRAFT.tex` is the **same bytes** as the May 18 “implies” draft (SHA `f51ed5c05ec3…`). **Not** the expected April Q6 / *A Spectral Coherence Criterion* / Dominant-Shell family. **Not** Final Polished. **Not** FIXED. **Not** August. **Not** Clay. **Not** a compile of June PDF `7de9444d…`. Do not re-file. **Do not use as closed.**
