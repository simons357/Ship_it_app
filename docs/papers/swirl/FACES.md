...
| Axisymmetric shell estimate (2026-09-12) | [`AXISYMMETRIC-SHELL-ESTIMATE.md`](AXISYMMETRIC-SHELL-ESTIMATE.md) | Door-1 shell budget on the **unaugmented axisymmetric-with-swirl** class. Quantity \(Z_j\). Only remainder \(T_{j\leftarrow j}\). Filter [`docs/domain-architect/AXISYMMETRIC-SHELL-AUDIT.md`](../../domain-architect/AXISYMMETRIC-SHELL-AUDIT.md). **Not** a compile of 22 August. **Not** leftover-split strain. **Not** Paper2 T2. Clay **NOT CLAIMED**. |
