# Ring Lemma + SND — separate book

Not Domain Architect. Not axisymmetric swirl. Not Paper2’s simplex \(H_N[a]\).
Not `Paper2_NS_Regularity_SND_FIXED.tex`.

Faces (not a compile of the 21 Aug Zenodo PDF): [`FACES.md`](FACES.md).
The April / June-era TeX stays on disk. It does **not** replace
[`02_ring_lemma_snd_conditional.pdf`](02_ring_lemma_snd_conditional.pdf).
**Do not overwrite** that PDF.

## Current public face (21 August 2026)

[`02_ring_lemma_snd_conditional.pdf`](02_ring_lemma_snd_conditional.pdf)

DOI: [10.5281/zenodo.22050976](https://doi.org/10.5281/zenodo.22050976)  
Earlier same-day file: [10.5281/zenodo.22045474](https://doi.org/10.5281/zenodo.22045474)

**SND in this paper** means \(\inf J(t)/X(t)\ge c_*>0\): a dominant Littlewood–Paley shell keeps a positive fraction of enstrophy. Unconditional SND for arbitrary large \(H^1\) data is **open**. No Clay claim.
