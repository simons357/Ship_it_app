...
## Submit queue (recommended order)

### 1. READY NOW — strongest

**Working title:** *Phi-renormalization for axisymmetric Navier–Stokes with swirl: algebraic cancellation of the \(1/r^4\) axis term*
...
This is your best paper.

---

### 2. READY AFTER ONE CLEAN PASS

**Working title:** *A Ring Lemma for band-limited vorticity direction and a conditional spectral non-dispersal criterion on \(\mathbb{T}^3\)*
...
### 3. READY AFTER ONE CLEAN PASS

**Working title:** *Shell-flux bounds and a Gronwall form of spectral non-dispersal (T2)*
...
### 4. OPTIONAL MICRO-NOTE

**Working title:** *A Rayleigh lower bound for normalized inverse-GCD on prime pairs*
...
### 5. OPTIONAL CONDITIONAL NOTE (lower priority)

**Working title:** *Route C: a spectral approach to zero-density estimates, conditional on two analytic gaps*

| | |
| --- | --- |
| **Source** | `10.5281/zenodo.20518388` |
| **What you claim** | Exactly what the title says — **conditional** |
| **Strip** | “RH closed,” Bridge floor unconditional, Triple Lock bundling |
| **Venue shape** | Exploratory arXiv note; expect skepticism; still publishable as conditional |
...
Keep those Zenodo records as **archive history** if you want timestamps; do not put them in a journal queue.
...
arXiv first beats waiting on referees. Journal later is optional vanity; the dated preprint is already a public reward.
