...
**On this branch.** Original JSON:
`results/ns_five_lane_2026-09-10/attack9b_exact_shell/`.
Phone: [`../../five-lane-export/ATTACK_9B.md`](../../five-lane-export/ATTACK_9B.md).
The `/opt/cursor/artifacts/attack9b_exact_shell/` path was the other VM.
Do not cash \(\max K\approx 0.641\) as \(C_0\).
