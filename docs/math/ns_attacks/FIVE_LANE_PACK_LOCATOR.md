...
| **Self-contained exact finite-support SoT core** | `/workspace/scripts/ns_attacks/ns_lemma_star_core.py` (note: `NS_LEMMA_STAR_CORE.md`; ★ OPEN) |
...
| **Unit tests** | `/workspace/tests/test_ns_attacks_lemma_star.py`, `/workspace/tests/test_ns_lemma_star_core.py` |
