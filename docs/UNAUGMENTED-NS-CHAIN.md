...
Axisymmetric-with-swirl shell estimate (unaugmented, \(\mathbb{R}^3\); quantity \(Z_j\); remainder \(T_{j\leftarrow j}\); identity and far-shell Young sit; [ρ] not measured; not a close): [`AXISYM-SHELL.md`](AXISYM-SHELL.md). Class samples of that remainder (local-remainder occupancy printed; not a class bound): [`AXISYM-SWIRL-PROBE.md`](AXISYM-SWIRL-PROBE.md). Wall / dictionary correction (occupation from the detector withdrawn): [`SWIRL-WALL-CORRECTION.md`](SWIRL-WALL-CORRECTION.md). Filter: [`ESTIMATE-AUDIT.md`](ESTIMATE-AUDIT.md). SND-to-regularity implication (shell condition, frequency drift, circularity; SND sitting is not a bound on \(X\)): [`SND-TO-REGULARITY.md`](SND-TO-REGULARITY.md). Displayed Theorem H fails even with \(X\le M\): [`SND-H-REVIEW.md`](SND-H-REVIEW.md). Repaired \(F_j\) bound sits; \(D^+\rho\) assembly is a ceiling, not a floor: [`SND-H-REPAIR.md`](SND-H-REPAIR.md). 16 Sep status handoff (four-bucket score; C10 not seated; SND is an instrument): [`NS-STATUS.md`](NS-STATUS.md), [`CENTERED-DRIFT.md`](CENTERED-DRIFT.md), [`SND-INSTRUMENT.md`](SND-INSTRUMENT.md). Handoff for collaborators (one-page sheet, then four named jobs; not a close): [`ISSUES-SHEET.md`](ISSUES-SHEET.md), [`HELP-OFF-DESK.md`](HELP-OFF-DESK.md). Desk: leftover WRITE (6) on the geometric path is **H1 = Lemma I on the ball** (\(A_{\mathrm{bad}}\) a priori). Energy-budget writing of the same leftover class: **Lemma★** (boxed unrestricted \(\sup\mathcal R_\star<\infty\) **killed** by \(v_n\); not a singular NSE solution; replacement closure open; K=0 dead; the \(a^4\) missing inequality dead; uniform pre-Young \(C\) dead; lattice packets including HH→L fan did not kill; grow-\(s\) samples historical). [`LEMMA-STAR.md`](LEMMA-STAR.md), [`LEMMA-STAR-GROWING-LAYER.md`](LEMMA-STAR-GROWING-LAYER.md), [`LEMMA-STAR-R.md`](LEMMA-STAR-R.md), [`math/ns_attacks/LEMMA_STAR_CANONICAL.md`](math/ns_attacks/LEMMA_STAR_CANONICAL.md), [`LEMMA-STAR-CORRECTIONS.md`](LEMMA-STAR-CORRECTIONS.md). Original five-lane JSON: [`five-lane-export/COMPUTE.md`](five-lane-export/COMPUTE.md). Attack 9B: [`five-lane-export/ATTACK_9B.md`](five-lane-export/ATTACK_9B.md). Counting lock: [`LEMMA-STAR-9B-COUNTING.md`](LEMMA-STAR-9B-COUNTING.md). Growing cube (named, computed; not a kill): [`LEMMA-STAR-CUBE.md`](LEMMA-STAR-CUBE.md). Analytic review (files absent; \(M_0\) not locked): [`LEMMA-STAR-CUBE-REVIEW.md`](LEMMA-STAR-CUBE-REVIEW.md). Do not merge ★ with H1, and do not merge either with global **H**. Lemma C is an if, not an H. **H2** a priori from energy is also open. **H3** (\(A_{\mathrm{ext}}\)) is a named remainder; a priori from energy is open. \(R_\phi\) is not free. If H1 sits and H2-from-energy does not, the cylinder is still open. Theorem A is a different PDE. DA-NS-2 and the old \(\int\mathcal R\) line are other writings of the same leftover. Keep Biot–Savart at \(1/r^4\). Do not add \(Q_1\). Do not add \(K(t)\) to the PDE. Glossary: [`H-SYSTEM.md`](H-SYSTEM.md).
