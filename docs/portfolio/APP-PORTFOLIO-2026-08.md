...
This is an independent read of what is actually on the shelf: live URLs, GitHub, hosted frontends, and the existing keep/cut and partner-packet inventory. It is not a bankable appraisal. There is no documented revenue, user count, LOI, or paid pilot in the public record.
...
**What a focused 18-month going-concern could be worth (pre-seed option, if you starve everything else):** **$0.5–2.5 million**. That number dies if capital and attention stay sprayed.

**What the catalog is not worth:** TITAN-X’s $90M year-five planning revenue, FieldEncrypt as “the world’s most secure encryption,” or FieldPredict as a finance product. Those are stories, not assets.

The money path is the same one already written in your keep/cut list and the anesthesia A-grade board: **sell domain products, not Millennium math.**

**Recommended book (fund these, park the rest):**
...
## 2. How this was valued

| Lens | What it means | How it was used |
| --- | --- | --- |
| **As-is** | What a buyer would pay this week for the code, names, and live demos | Low. Pre-revenue shells. |
| **12-month cash odds** | Chance of a real paying customer if this is the *only* thing you push | Ranking order |
| **Focused option** | Value if you spend 18 months and do not start new brands | Upper bound, not NAV |
| **Credibility tax** | Inflated claims (“unbreakable,” “Clay,” untested drag %) | Subtracts value from the *whole* book |

Comparables used as a sanity check, not as a model: indie SaaS with a demo and no users sells for roughly asset value; a CRNA-authored clinical decision-support concept with no 510(k) is an option, not a device company; a stratospheric aerostat on paper is not a software holding.
...
Collider, Drafts, FieldSandbox, Genesis, HarmonicPlayground, ParticlePool, PrimePhysics, QuantumLab, Vortex, Home, Settings, plus Maritime **Harmonic Insights** and **Resources**, plus Prime Field **ManagePanels**.

Treat these as **skins of Explorer + Maritime**, not as a portfolio of startups.

### 3.3 Not apps — still on the shelf

| Name | What it actually is |
| --- | --- |
| AquaQuarts / EZ water | Luxury tableside water ritual · patent **not filed** |
| Vigilant Patch | Wearable vigilance concept · CRNA-grounded · not a cleared device |
| Reflex Staircase | Protocol / teaching pack for Operator Assist |
| HoloBase | Hollow-base holographic cradle · design, not filed |
| TITAN-X | Stratospheric aerostat concept + investor HTML/PDF |
| ProVR Tools | Patent-pending haptic training (claimed) |
| AI Surgeon VR | Long-cycle training / trailer script |
...
## 4. Ranked holdings — most likely to monetize first
...
| --- | --- |
| **As-is** | $0 (spec only) |
| **If focused 18 months** | Teaching edition $20k–$80k; hospital CDS is slower ($0–$400k if a program actually buys) |
| **12-month cash odds** | Medium — fastest via **schools / sim**, not via FDA |
| **Why it belongs** | This is the only software idea that matches what you actually do for a living: manage complexity at the head of the table. “Many futures → short menu → you choose” is a product, not a metaphor. Cognitive-load CDS is a market. You have domain authority nobody else in this repo has. |
...
| | |
| --- | --- |
| **As-is** | $5k–$40k (working public kiosk) |
| **If focused 12 months** | $0–$80k in paid peeks / NDA evals if you stop selling “unbreakable” |
...
| | |
| --- | --- |
| **As-is** | $5k–$30k (live dashboard frontend) |
| **If focused 12 months** | $0–$120k for **one** port / insurer / ops pilot |
| **12-month cash odds** | Medium-low — need a buyer and legal data (AIS, weather), not a screenshot |
| **Why it belongs** | You already shipped a working view. Ports, lanes, and instability-before-failure is a sentence operators understand. HarborShield is the same product in a defense/port coat. One brand, one dashboard. |
...
| | |
| --- | --- |
| **As-is** | $0–$50k option (unfiled concept + CRNA story) |
| **If focused** | Real money is 3–7 years (sensors + SaMD). Not 12-month cash. |
| **12-month cash odds** | Low |
| **Why it belongs** | “For people who cannot afford to fall asleep. Ever.” is a category. OR, ICU, drivers, watchstanding. Your clinical intuition about lagging indices is the insight. It should **feed** Operator Assist, not lead the company. |
...
| | |
| --- | --- |
| **As-is** | $10k–$75k **if** the provisional is real and claims stay honest |
| **If focused** | A metered coating / pipe **pilot** is the only cash path |
| **12-month cash odds** | Low unless a materials partner appears |
| **Why it belongs** | Live demo + industrial/defense surface is a lane primes understand. Industrial pipes (flow / pump energy) is a better first sale than missiles. |
...
| | |
| --- | --- |
| **As-is** | $0–$20k (landing pages; solenne.ai is “coming soon”) |
| **If focused** | Beauty-tech is real ($ subscriptions + affiliate) and brutally competitive |
| **12-month cash odds** | Low unless a **shipped** consumer app exists |
| **Why it belongs** | Correct monetization map (Light vs Premium, affiliate, provider referrals). Huge market. Founder has a medical-aesthetics story. |
...
| | |
| --- | --- |
| **As-is** | $0–$15k (live site, brand) |
| **If focused** | Courses, talks, a real book SKU: $0–$25k/year |
| **12-month cash odds** | Low-medium for small consumer $ |
| **Why it belongs** | It is the public **expository** face of the work. Fine as art and teaching. The ringdown experiment on this repo **did not reject H0** — so this is brand, not proof. |
...
| --- | --- |
| **As-is** | $0–$5k |
| **12-month cash odds** | Very low |
| **Why it belongs** | Cheap to keep. Clear UX contract (Answer · Why · Next steps). Character IP if you ever want a wellness companion. |
...
| | |
| --- | --- |
| **As-is** | $0–$10k (visualizer) |
| **12-month cash odds** | Near zero as SaaS |
| **Why it belongs** | Best **show** piece for art / physics rooms. One product, many rooms (Vortex, Genesis, ParticlePool, …). |
...
| --- | --- |
| **As-is** | $0 (empty shell) |
| **Why it might belong later** | “Evernote of AI chats” is a sentence people understand. |
...
| --- | --- |
| **As-is** | $0 |
| **Why it does not belong** | Already abandoned (PR #13). GitHub-for-non-git-users is a graveyard of tools. Prior standing order: do not revive. |
| **Portfolio job** | **Cut. This repo is a workshop, not the product.** |

---

## 5. Do not monetize — or they tax the rest of the book
...
| **Pac-Man / Risk clones** | **Hobby** | No original IP. Do not show in partner decks. |
| **Planet Hunter, Scallion** | **Cut** | Already marked abandon. |
| **Millennium / Triple Lock / “RH proved” papers** | **Do not sell** | Keep/cut already froze this. Phi-renorm as a *method note* is the math keeper. Prize packaging is not a product. |
| **EEG earphones / Music OS / AI Surgeon VR / ProVR** | **Later or partner-only** | Hardware + medical-adjacent. Long cycle. |
| **HoloBase** | **File or shelf** | Design without a filing is a conversation, not an asset. |
| **TITAN-X** | **Not an app. Not year-one cash.** | $13M/unit planning CAPEX, $90M Y5 illustrative revenue. Concept art + HTML. Needs a pathfinder vehicle and serious capital. Keep the deck in a vault; do not let it eat the software beam. |

---

## 6. Portfolio construction (what to own)
...
**Concentration:** 80% of hours on Books A–C. 15% on filing Vigilant/AquaQuarts/NAV-42 IP. 5% on keeping live demos from rotting.
...
## 7. What I think the whole book is worth

| View | Range | Read |
| --- | --- | --- |
| **Liquid / as-is software** | **$25k–$120k** | Demos and names. No ARR. |
| **Unfiled IP optionality** | **$0–$200k** | Goes to ~$0 if you never file and keep talking process in public. |
| **Focused 18-month going concern** | **$0.5M–$2.5M** | Pre-seed *if* AquaQuarts or Assist has evidence (orders, a teaching contract, or a paid B2B peek). |
| **Spray continuation (status quo)** | **~$0–$50k and falling** | New brands dilute the old ones. Credibility tax compounds. |
| **TITAN-X paper plan** | **$0 as an app** | Treat as a separate, unfunded concept. Do not add its TAM into this portfolio NAV. |

If you need a single number for “what is our inventory of apps worth this week,” use **about $50,000**, with a **call option** that is only in the money if you run three holdings and starve the rest.
...
- Keep/cut: `docs/KEEP-CUT-INVENTORY.md` (2026-08-02)  
- Anesthesia A-board: `docs/anesthesia/A-GRADE-PRODUCTS.md`  
- TITAN-X planning figures: `docs/titan-x/CONSOLIDATED-SUMMARY.md`, `EXECUTIVE-BUSINESS-PLAN.md`  
- Closed science note on this repo: `docs/HB-RINGDOWN-EXPERIMENT-01-REPORT.md` (H0 not rejected)  
- Abandoned apps: PR #13 (Ship It, Planet Hunter, Scallion)  
- Public company/product pages: primefield.tech, LinkedIn product notes (HarborShield, FieldEncrypt, Maritime)
