...
| [06 — Exact-shell claimed lock](06-EXACT-SHELL-CLAIMED-LOCK.md) | \(K\le 16/9\) CLAIMED on one shell; unrestricted \(\star\) already dead; not a regularity close; Soft X silent |
