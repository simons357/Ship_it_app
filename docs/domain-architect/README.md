...
| [06 — Exact-shell claimed lock](06-EXACT-SHELL-CLAIMED-LOCK.md) | Pointer. Full page: [`ATTACK-9D-FULL-SUPPORT-BOUND.md`](../ATTACK-9D-FULL-SUPPORT-BOUND.md). Questions: [`ATTACK-9D-SPECIALIST-QUESTIONS.md`](../ATTACK-9D-SPECIALIST-QUESTIONS.md). Tree: [`NS-TREE.md`](../NS-TREE.md) |
