...
- DA class-hunt brief (2026-09-16): ranked routes to a usable CLASS for Door-1 / (A) — Rank 1 \(\theta\)-class bridge; Rank 2 sparse/near-scale-free support; Rank 3 pure-swirl / small-data / extra symmetry as conditional only. Axisym alone does not seat mixed (A). Card: [`DA-CLASS-HUNT-BRIEF.md`](DA-CLASS-HUNT-BRIEF.md). **(A) not seated.** DA-VC-01 stays **FAIL**.
