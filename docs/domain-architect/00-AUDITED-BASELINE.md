...
| \(\lambda\) | scale response | wavelength, eigenvalue, inverse operator, spectral weight, propagator |
...
| 1 | mathematical compatibility | gravity role map |
| 2 | known-limit recovery | Newtonian / linearized gravity with \(P=I\) |
