# Zenodo remediation — `ring-lemma-early`

| Field | Value |
| --- | --- |
| Record ID | `19842060` |
| DOI | `10.5281/zenodo.19842060` |
...
[Superseded - see errata] Borromean Triads, the Ring Lemma, and Spectral Non-Dispersal

## Errata in title?

`True` (expected fix if live still has a banner)

## Withdrawn claims

- Unconditional regularity implied by early SND packaging

**Superseded by:** `10.5281/zenodo.22050976`
...
<p><strong>Withdrawn claims:</strong></p><ul><li>Unconditional regularity implied by early SND packaging</li></ul>
<p><strong>Corrected public note:</strong> <a href="https://doi.org/zenodo.22050976">10.5281/zenodo.22050976</a></p>
