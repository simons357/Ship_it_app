# Zenodo remediation — `snd-framework-old`

| Field | Value |
| --- | --- |
| Record ID | `20518057` |
| DOI | `10.5281/zenodo.20518057` |
...
- Unconditional NS regularity implied by framework as written
...
Superseded by corrected Ring+SND note. Soft description pointer only.
