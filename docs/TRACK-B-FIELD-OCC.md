...
B18e is scored. Field glue is not an a priori (B19e). NS climb is not an a priori (B20e). Climb sketch is not an a priori (B21e). Next: DNS leftover (B23e). Finer is B22e.
