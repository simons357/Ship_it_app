# Owner fill-in (completed from evidence, not from the empty table)

| Field | Value |
|---|---|
| What ChatVault does, one sentence | A vault for AI conversations and research notes that keeps raw text, source, and a human claim ledger — not a truth engine. |
| Who it's for | Jonathan first; later, people who need private/professional AI memory they can export. |
| Base44 project URL — build A | https://preview--6a58f25d90370ad28d426a88.base44.app/ (landing + Drive) |
| Base44 project URL — build B ("morphed glass") | https://preview--6a58e103fedcde66a0a7710e.base44.app/ |
