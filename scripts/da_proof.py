...
NS_LINES = [
    ...
    },
    {
        ...
        "status": "write",
        "text": (
            "WRITE. Live leftover: H1 = Lemma I on the ball (A_bad a priori on Q_r). "
            "Not global H. Lemma C is an if, not an H. Do not merge letters. "
            ...
            "If H1 sits and H2-from-energy does not, the cylinder is still open. "
