...
def lemma_glue_leftover() -> dict:
    return rec(
        ...
        "fail",
        "Scored as B19e / B30. A wrong-sign sketch is not continuation. NS climb is not an a priori (B20e). Climb sketch is not an a priori (B21e). Finer box is not an a priori (B22e). DNS leftover is B23e. Do not spawn n=64.",
    )
...
def run(out: Path | None = None) -> dict:
    ...
    payload = {
        ...
        "next_da_move": (
            ...
            "Field occupation is not an a priori (B18e). Field glue is not an a priori (B19e). NS climb is not an a priori (B20e). Climb sketch is not an a priori (B21e). Finer box is not an a priori (B22e). DNS leftover is B23e. "
