...
Standalone exact evaluator. Path: scripts/ns_lemma_star_core.py.
Does not import the Stokes library. Live
scripts/ns_attacks/stokes_moments.py is not replaced.
A match on a sample is not a proof. Lemma★ is still open.
