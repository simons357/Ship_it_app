...
def lemma_budget_leftover() -> dict:
    return rec(
        ...
        "fail",
        "Scored as B15e / B26. A share of (ω·Sω)_+ is not continuation. Enstrophy balance is not an a priori (B16e). Coherent leftover is B17e. Do not spawn n=64.",
    )
...
def run(out: Path | None = None) -> dict:
    ...
    payload = {
        ...
        "next_da_move": (
            ...
            "Enstrophy balance is not an a priori (B16e). Coherent leftover is B17e. Finer (n>32) stays a box knob (B22e). "
