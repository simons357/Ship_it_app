...
def lemma_budget_leftover() -> dict:
    return rec(
        ...
        "fail",
        "Scored as B15e / B26. A share of (ω·Sω)_+ is not continuation. Enstrophy balance is not an a priori (B16e). Coherent blob is not an a priori (B17e). Field occupation is not an a priori (B18e). Field glue is not an a priori (B19e). NS climb is not an a priori (B20e). Climb-sketch leftover is B21e. Do not spawn n=64.",
    )
...
def run(out: Path | None = None) -> dict:
    ...
    payload = {
        ...
        "next_da_move": (
            ...
            "Enstrophy balance is not an a priori (B16e). Coherent blob is not an a priori (B17e). Field occupation is not an a priori (B18e). Field glue is not an a priori (B19e). NS climb is not an a priori (B20e). Climb-sketch leftover is B21e. Finer (n>32) stays a box knob (B22e). "
