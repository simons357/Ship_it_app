...
def lemma_occupation_leftover() -> dict:
    return rec(
        ...
        "fail",
        "Scored as B18e / B29. A clock that stays CONC is not continuation. Field glue is not an a priori (B19e). NS-climb leftover is B20e. Do not spawn n=64.",
    )
...
def run(out: Path | None = None) -> dict:
    ...
    payload = {
        ...
        "next_da_move": (
            ...
            "Field occupation is not an a priori (B18e). Field glue is not an a priori (B19e). NS-climb leftover is B20e. Finer (n>32) stays a box knob (B22e). "
