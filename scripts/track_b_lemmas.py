...
def lemma_miller_readable() -> dict:
    from track_b_residual import lemma_miller_readable as mr

    return mr()


def lemma_miller_not_a_priori() -> dict:
    from track_b_residual import lemma_miller_not_a_priori as mna

    return mna()


def lemma_miller_not_continuation() -> dict:
    from track_b_residual import lemma_miller_not_continuation as mnc

    return mnc()


def lemma_miller_not_ns() -> dict:
    from track_b_residual import lemma_miller_not_ns as mns

    return mns()


def lemma_miller_not_integral_max() -> dict:
    from track_b_residual import lemma_miller_not_integral_max as mnim

    return mnim()


def lemma_miller_not_regularity() -> dict:
    from track_b_residual import lemma_miller_not_regularity as mnr

    return mnr()


def lemma_miller_not_a_retune() -> dict:
    from track_b_residual import lemma_miller_not_a_retune as mnr2
...
def lemma_blanks_readable() -> dict:
    from track_b_residual import lemma_blanks_readable as br

    return br()


def lemma_blanks_not_a_priori() -> dict:
    from track_b_residual import lemma_blanks_not_a_priori as bna

    return bna()


def lemma_blanks_not_continuation() -> dict:
    from track_b_residual import lemma_blanks_not_continuation as bnc

    return bnc()


def lemma_blanks_not_ns() -> dict:
    from track_b_residual import lemma_blanks_not_ns as bns

    return bns()


def lemma_blanks_not_integral_max() -> dict:
    from track_b_residual import lemma_blanks_not_integral_max as bnim

    return bnim()


def lemma_blanks_not_regularity() -> dict:
    from track_b_residual import lemma_blanks_not_regularity as bnr

    return bnr()


def lemma_blanks_not_a_retune() -> dict:
    from track_b_residual import lemma_blanks_not_a_retune as bnr2
