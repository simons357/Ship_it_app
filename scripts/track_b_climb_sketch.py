...
def lemma_sketch_not_close() -> dict:
    return rec(
        ...
        "fail",
        "Scored as B32. A short window is not the sitting of B11c. The sketch grew. The field fell. Finer box is not an a priori (B22e). Finer DNS is not an a priori (B23e). Regularity leftover is open.",
    )
