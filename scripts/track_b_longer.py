...
def lemma_finer_open() -> dict:
    return rec(
        ...
        "fail",
        "Scored as B33. A bigger FFT is not continuation. n is a knob on the box. Finer DNS is not an a priori (B23e). Leftover close is not an a priori (B34e). Regularity leftover is not an a priori (B35e). Regularity stays open. Do not spawn n=64.",
    )
