...
def lemma_climb_leftover() -> dict:
    return rec(
        ...
        "open",
        "The sketch is scored. The leftover close on NS climb is B20e. Not a bigger FFT. Do not spawn n=64.",
    )
...
def run(out: Path | None = None) -> dict:
    ...
    payload = {
        ...
        "next_da_move": (
            ...
            "NS-climb leftover is B20e. Finer (n>32) stays a box knob (B22e). "
