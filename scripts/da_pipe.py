...
VERDICTS = [
    ...
    rec(
        ...
        "B4b_Itube",
        "falsify",
        "B4b fail: Hardy absorbs I_tube for all data",
        "fail",
        "Killed by a slow fat swirl h = r sin(εz). Ratio |I_tube|/diss ∼ 1/ε.",
        killer="slow fat swirl, R ∼ 1/ε",
        if_killed="B4b → fail; use B4c on packets; next write is Bony T",
        if_survives="would have stayed open",
        slot="B",
    ),
    rec(
        "V4",
