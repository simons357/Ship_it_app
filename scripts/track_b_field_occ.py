...
def lemma_field_occ_not_close() -> dict:
    return rec(
        ...
        "fail",
        "Scored as B29. Occupation of CONC is not continuation. The clock did not leave. Field glue is not an a priori (B19e). NS climb is not an a priori (B20e). Climb sketch is not an a priori (B21e). Finer box is not an a priori (B22e). DNS leftover is B23e.",
    )
