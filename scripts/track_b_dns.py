...
def lemma_finer_still_open() -> dict:
    return rec(
        ...
        "fail",
        "Scored as B34. Same knob as B22e. A finer DNS run is not continuation. Leftover close is not an a priori (B34e). Regularity leftover is not an a priori (B35e). Regularity stays open. Do not spawn n=64.",
    )
