...
def lemma_sketch_leftover() -> dict:
    return rec(
        ...
        "open",
        "The field climb is scored. The leftover close on the climb sketch is B21e. Not a bigger FFT. Do not spawn n=64.",
    )
...
def run(out: Path | None = None) -> dict:
    ...
    payload = {
        ...
        "next_da_move": (
            ...
            "NS climb is not an a priori (B20e). Climb-sketch leftover is B21e. "
