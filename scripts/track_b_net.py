...
def lemma_coherent_leftover() -> dict:
    return rec(
        ...
        "fail",
        "Scored as B17e / B28. A one-sided leftover is not continuation. Field occupation is not an a priori (B18e). Field glue is not an a priori (B19e). NS climb is not an a priori (B20e). Climb sketch is not an a priori (B21e). Finer box is not an a priori (B22e). DNS leftover is B23e. Do not spawn n=64.",
    )
