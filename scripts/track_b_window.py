...
def lemma_finer_box_leftover() -> dict:
    return rec(
        ...
        "fail",
        "Scored as B22e / B33. A bigger FFT is not continuation. Finer DNS is not an a priori (B23e). Regularity leftover is open. Do not spawn n=64.",
    )
...
def run(out: Path | None = None) -> dict:
    ...
    payload = {
        ...
        "next_da_move": (
            ...
            "Finer box is not an a priori (B22e). Finer DNS is not an a priori (B23e). Regularity leftover is open. Finer (n>32) stays a box knob (B22e). "
