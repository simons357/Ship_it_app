...
def lemma_finer_box_leftover() -> dict:
    return rec(
        ...
        "fail",
        "Scored as B22e / B33. A bigger FFT is not continuation. Finer DNS is not an a priori (B23e). Leftover close is not an a priori (B34e). Regularity stays open. Do not spawn n=64.",
    )
...
def run(out: Path | None = None) -> dict:
    ...
    payload = {
        ...
        "next_da_move": (
            ...
            "Finer box is not an a priori (B22e). Finer DNS is not an a priori (B23e). Leftover close is not an a priori (B34e). Regularity stays open. Finer (n>32) stays a box knob (B22e). "
