...
Not ChatVault, not Domain Architect, not RH, not NS. **Not a medical device.**

The 28 Aug 2026 dump said there were **two**. Both Warrior Surgeon `.docx` uploads are the **same bytes** (`md5 08bca7fbdf5ed9f27da7bdf13e80ddc3`). They were one blob. This desk splits them by **voice**, not by filename.

| Voice | Whose | File | Drives |
|---|---|---|---|
| **THEIRS** | User medical big picture | [`THEIRS-medical-big-picture.md`](THEIRS-medical-big-picture.md) | The **playable product** |
| **HARRISON’S** | Arthurian Lady of the Lake | [`HARRISONS-arthurian-lady-of-the-lake.md`](HARRISONS-arthurian-lady-of-the-lake.md) | Mythic **authority that gives the sword** |

How the novel disagrees with the 2026 desk (keep both): [`WARRIOR-SURGEON.md`](WARRIOR-SURGEON.md).

Source blob (kept, not overwritten): [`warrior-surgeon/`](warrior-surgeon/).
...
Not a medical device. Not a clinical reference. Not a substitute for supervised training.
