...
class DaMachineTests(unittest.TestCase):
    ...
    def test_tube_hardy_lands_in_b_and_solved_ns_fails(self):
        ...
        look = classify_claim("DA look: look at the object")
        self.assertEqual(look["domain"], "U")
        self.assertEqual(look["verdict"], "open")
        ...
        trackb_write = classify_claim("Track B please write")
        self.assertEqual(trackb_write["domain"], "U")
        self.assertEqual(trackb_write["verdict"], "open")
        tracka_write = classify_claim("track A write")
        self.assertEqual(tracka_write["domain"], "U")
        self.assertEqual(tracka_write["verdict"], "open")
        rh = classify_claim("RH proof chain please")
        self.assertEqual(rh["domain"], "U")
        self.assertEqual(rh["verdict"], "open")
        paper_rh = classify_claim("use my best paper and write RH please")
        self.assertEqual(paper_rh["domain"], "U")
        self.assertEqual(paper_rh["verdict"], "open")
        done = classify_claim("is that right for Navi Stokes")
        self.assertEqual(done["domain"], "U")
        self.assertEqual(done["verdict"], "open")
        q6 = classify_claim("what about Q6 and the electoral floor")
        self.assertEqual(q6["domain"], "U")
        self.assertEqual(q6["verdict"], "open")
        study = classify_claim("these questions are directed at DA")
        self.assertEqual(study["domain"], "U")
        self.assertEqual(study["verdict"], "open")
        repair = classify_claim("what's wrong with the augmented one")
        self.assertEqual(repair["domain"], "U")
        self.assertEqual(repair["verdict"], "open")
        fix = classify_claim("how to fix SND")
        self.assertEqual(fix["domain"], "U")
        self.assertEqual(fix["verdict"], "open")
