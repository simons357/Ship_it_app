...
class DaLeadsTests(unittest.TestCase):
    ...
    def test_sweep_is_process_not_a_close(self):
        ...
        self.assertEqual(by["R52"]["verdict"], "fail")
        self.assertEqual(by["R53"]["verdict"], "fail")
        self.assertEqual(by["R54"]["verdict"], "fail")
        self.assertEqual(by["R55"]["verdict"], "fail")
        self.assertEqual(by["R56"]["verdict"], "fail")
        self.assertEqual(by["R57"]["verdict"], "fail")
        self.assertEqual(by["R58"]["verdict"], "fail")
        self.assertEqual(by["R59"]["verdict"], "fail")
        self.assertEqual(by["R60"]["verdict"], "fail")
        self.assertEqual(by["R61"]["verdict"], "fail")
        self.assertEqual(by["R62"]["verdict"], "fail")
        self.assertEqual(by["R63"]["verdict"], "fail")
        self.assertEqual(by["R64"]["verdict"], "fail")
        self.assertEqual(by["R65"]["verdict"], "fail")
        self.assertEqual(by["R66"]["verdict"], "fail")
        self.assertEqual(by["R67"]["verdict"], "fail")
        self.assertEqual(by["R68"]["verdict"], "fail")
