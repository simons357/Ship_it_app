...
class TestVal8000Mouth(unittest.TestCase):
    ...
    def test_guide_locks_idle_line_and_smile_after_answer(self) -> None:
        ...
        self.assertIn("Idle is not teeth.", text)
        ...
        self.assertIn("Teeth are not after ordinary straight explanations.", text)
        ...
        self.assertNotIn("Rare gag only.", text)
    ...
    def test_public_post_idle_line_smile_after_answer_not_hal(self) -> None:
        ...
        self.assertIn("never the masthead", public.lower())
        self.assertIn("compliments him", public)
        self.assertIn("joke lands", public)
        self.assertIn("sarcastic", public)
