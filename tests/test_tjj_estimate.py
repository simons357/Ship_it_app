...
class TjjEstimateTests(unittest.TestCase):
    def test_page_refuses_the_line(self):
        ...
        self.assertIn("Proposition TJJ-pure", text)
        self.assertIn("Proposition TJJ-AS-split", text)
    ...
    def test_probe_scores(self):
        ...
        self.assertEqual(rows["TJJ_pure_swirl_vanishes"]["verdict"], "pass")
        self.assertEqual(rows["TJJ_as_bilinear_split"]["verdict"], "pass")
        self.assertEqual(rows["TJJ_requested_line"]["verdict"], "fail")
        self.assertLess(payload["axisym_split"]["pure_T_all_rel"], 1e-12)
        self.assertLess(payload["axisym_split"]["mix"]["split_rel"], 1e-8)
