...
class DaLivingTests(unittest.TestCase):
    def test_living_is_process_not_a_close(self):
        ...
        self.assertEqual(by["L56"]["verdict"], "fail")
        self.assertEqual(by["L57"]["verdict"], "fail")
        self.assertEqual(by["L58"]["verdict"], "fail")
        self.assertEqual(by["L59"]["verdict"], "fail")
        self.assertEqual(by["L60"]["verdict"], "fail")
        self.assertEqual(by["L61"]["verdict"], "fail")
        self.assertEqual(by["L62"]["verdict"], "fail")
        self.assertEqual(by["L63"]["verdict"], "fail")
        self.assertEqual(by["L64"]["verdict"], "fail")
        self.assertEqual(by["L65"]["verdict"], "fail")
        self.assertEqual(by["L66"]["verdict"], "fail")
        self.assertEqual(by["L67"]["verdict"], "fail")
        self.assertEqual(by["L68"]["verdict"], "fail")
        self.assertEqual(by["L69"]["verdict"], "fail")
        self.assertEqual(by["L70"]["verdict"], "fail")
        self.assertEqual(by["L71"]["verdict"], "fail")
    ...
    def test_no_dead_fluids_in_living_room(self):
        dead = {"Leray", "Kato", "Majda", "Ladyzhenskaya", "Nirenberg", "Scheffer", "Sohr", "Foias", "Heywood", "Bourgain", "Pruss", "Raugel"}
