...
class DaAgentTests(unittest.TestCase):
    def test_agent_is_process_not_a_close(self):
        ...
        self.assertIn("Pavlovic", payload["tick"]["seated_living"])
        self.assertIn("Rusin", payload["tick"]["seated_living"])
        self.assertIn("Germain", payload["tick"]["seated_living"])
        self.assertIn("Cao", payload["tick"]["seated_living"])
        self.assertIn("Hieber", payload["tick"]["seated_living"])
        self.assertIn("Bedrossian", payload["tick"]["seated_living"])
        ...
        self.assertIn("Iftimie", payload["tick"]["seated_living"])
        self.assertIn("Fursikov", payload["tick"]["seated_living"])
        self.assertIn("Maremonti", payload["tick"]["seated_living"])
        self.assertIn("Korobkov", payload["tick"]["seated_living"])
        self.assertIn("Hishida", payload["tick"]["seated_living"])
        self.assertIn("Mucha", payload["tick"]["seated_living"])
        self.assertIn("Paicu", payload["tick"]["seated_living"])
        self.assertIn("Gibbon", payload["tick"]["seated_living"])
        self.assertIn("Ambrosio", payload["tick"]["seated_living"])
        self.assertIn("Enciso", payload["tick"]["seated_living"])
        self.assertIn("Feireisl", payload["tick"]["seated_living"])
        self.assertIn("Kiselev", payload["tick"]["seated_living"])
