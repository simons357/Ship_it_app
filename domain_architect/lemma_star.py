...
FIVE_LANE_STATUS: dict[str, Any] = {
    ...
    "lanes": {
        ...
        "attack_9c": "NEGATIVE_FOR_KILL_NATURAL_SAME_SHELL_SOT_ONLY",
    ...
    "cross_link": (
        ...
        "9C fixed-gap = not a kill (SoT-only); 9D remaining falsifier = Θ(m²); "
        "numeric bound ≠ uniform bound on R_★"
    ),
    "headline": (
        "K=0 dead ↔ D_s=0 kill criterion; kill lane LIVE (both directions); "
        "Attack 9A fail; 9B K_{α,β}; 9C fixed-gap; 9D Θ(m²); "
