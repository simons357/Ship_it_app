...
| Item | Value |
|------|-------|
| Source branch (PR #48) | `cursor/ns-five-lane-lemma-star-1390` |
| Handoff branch (scripts on disk) | `cursor/five-lane-scripts-handoff-0cc5` |
...
| **Attack 9B exact-shell \(K\)** | `/workspace/scripts/ns_attacks/attack9b_exact_shell_K.py` |
...
### Jonathan handoff drop (GROK-HEAVY)

Scripts + SoT mirrored for shared-box runs (source tip: PR #48 / `origin/cursor/ns-five-lane-lemma-star-1390`):

| Role | Absolute path |
|------|----------------|
| **Handoff scripts (pack)** | `/workspace/jonathan-handoff/GROK-HEAVY/01-swirl-publishing/five-lane-pack/scripts/ns_attacks/` |
| **Handoff SoT docs** | `/workspace/jonathan-handoff/GROK-HEAVY/01-swirl-publishing/lemma-star-sot/` |
| **Handoff tests** | `/workspace/jonathan-handoff/GROK-HEAVY/01-swirl-publishing/five-lane-pack/tests/test_ns_attacks_lemma_star.py` |
| **Handoff locator copy** | `/workspace/jonathan-handoff/GROK-HEAVY/01-swirl-publishing/lemma-star-sot/FIVE_LANE_PACK_LOCATOR.md` |

**9B one-liner (from repo root):**

```bash
PYTHONPATH=scripts python3 scripts/ns_attacks/attack9b_exact_shell_K.py --kmax 6 --trials 60 --refine 30 --seed 1390
```

All key SoT files under `/workspace/docs/math/ns_attacks/` and scripts under `/workspace/scripts/ns_attacks/` are present on this handoff branch (copied from PR #48 tip).
